        ...
        <div>
          ...
          <div className="relative flex items-center">
            <input
              ...
              className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 focus:ring-blue-500 focus:border-blue-500 text-sm transition-colors duration-300 pr-10"
            />
